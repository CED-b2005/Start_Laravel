  ...
  <table id="table_admin_product" class="table table-striped display">
    <thead>
      <tr>
        ...
        <th scope="col">New</th>
        <th scope="col"><a href="{{route('admin.add-form')}}" class="btn btn-primary" style="width:80px;">Add</a></th>
      </tr>
    </thead>
    <tbody>
      ...
      <tr class="products-list-admin">
        ...
        <th><img src="source/source/image/product/{{$product->image}}" alt="image" style="height: 100px;" /></th>
        <td>{{$product->name}}</td>
